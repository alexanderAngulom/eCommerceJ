...
/**
 * REST controller for managing {@link com.olimpo.net.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
public class CustomerDetailsResource {
    ...
    public ResponseEntity<CustomerDetails> getCustomerDetails(@PathVariable UUID id) {
    ...
    public ResponseEntity<Void> deleteCustomerDetails(@PathVariable UUID id) {
