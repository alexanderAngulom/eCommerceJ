...
/**
 * REST controller for managing {@link com.olimpo.net.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
public class ProductOrderResource {
    ...
    public ResponseEntity<ProductOrder> getProductOrder(@PathVariable UUID id) {
    ...
    public ResponseEntity<Void> deleteProductOrder(@PathVariable UUID id) {
