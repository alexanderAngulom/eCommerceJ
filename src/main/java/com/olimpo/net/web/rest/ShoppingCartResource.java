...
import com.olimpo.net.service.ShoppingCartService;
...
/**
 * REST controller for managing {@link com.olimpo.net.domain.ShoppingCart}.
 */
@RestController
@RequestMapping("/api")
public class ShoppingCartResource {
    ...
    public ResponseEntity<ShoppingCart> getShoppingCart(@PathVariable UUID id) {
