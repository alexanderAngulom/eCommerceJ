...
import com.olimpo.net.domain.enumeration.Gender;
import com.olimpo.net.repository.CustomerDetailsRepository;
import com.olimpo.net.service.CustomerDetailsService;
...
class CustomerDetailsResourceIT {
    ...
    void getAllCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(customerDetails.getId().toString())))
    ...
    void getCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(customerDetails.getId().toString()))
    ...
    void getNonExistingCustomerDetails() throws Exception {
        // Get the customerDetails
        restCustomerDetailsMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            .perform(delete(ENTITY_API_URL_ID, customerDetails.getId().toString()).accept(MediaType.APPLICATION_JSON))
