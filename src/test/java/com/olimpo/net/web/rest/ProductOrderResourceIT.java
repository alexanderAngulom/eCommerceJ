package com.olimpo.net.web.rest;

import static com.olimpo.net.web.rest.TestUtil.sameNumber;
...
import com.olimpo.net.IntegrationTest;
import com.olimpo.net.domain.Product;
import com.olimpo.net.domain.ProductOrder;
import com.olimpo.net.domain.ShoppingCart;
import com.olimpo.net.repository.ProductOrderRepository;
import com.olimpo.net.service.ProductOrderService;
...
class ProductOrderResourceIT {
    ...
    void getAllProductOrders() throws Exception {
        ...
        restProductOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(productOrder.getId().toString())))
    ...
    void getProductOrder() throws Exception {
        ...
        restProductOrderMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(productOrder.getId().toString()))
    ...
    void getNonExistingProductOrder() throws Exception {
        // Get the productOrder
        restProductOrderMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingProductOrder() throws Exception {
        int databaseSizeBeforeUpdate = productOrderRepository.findAll().size();
        productOrder.setId(UUID.randomUUID());
    ...
    void deleteProductOrder() throws Exception {
        ...
        restProductOrderMockMvc
            .perform(delete(ENTITY_API_URL_ID, productOrder.getId().toString()).accept(MediaType.APPLICATION_JSON))
