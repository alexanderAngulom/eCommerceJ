...
import com.olimpo.net.domain.enumeration.OrderStatus;
import com.olimpo.net.domain.enumeration.PaymentMethod;
import com.olimpo.net.repository.ShoppingCartRepository;
...
class ShoppingCartResourceIT {
    ...
    void getAllShoppingCarts() throws Exception {
        ...
        restShoppingCartMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(shoppingCart.getId().toString())))
    ...
    void getNonExistingShoppingCart() throws Exception {
        // Get the shoppingCart
        restShoppingCartMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteShoppingCart() throws Exception {
        ...
        restShoppingCartMockMvc
            .perform(delete(ENTITY_API_URL_ID, shoppingCart.getId().toString()).accept(MediaType.APPLICATION_JSON))
